 ...
 * @return void
 */
LightwaveRF.prototype.setMood = function(roomId, moodId, callback) {
        this.sendUdp("!R" + roomId + "FmP" + moodId + "|\0", callback);
}
...
lightwaveRf.setMood(6, 0, function(_error, _content) {
   if (_error) {
      console.log('Error registering' + _error.message);
   } else {
