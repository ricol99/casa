...
function ServiceProperty(_config, _owner) {
   ...
   this.serviceProperty = _config.hasOwnProperty("serviceProperty") ? _config.serviceProperty : this.name;
   ...
   _config.source = { uName: sourceName, property: this.serviceProperty, subscription: { subscriber: this.owner.uName, sync: this.sync, args: this.serviceArgs } };
   ...
   if (this.sync.endsWith("write")) {
      _config.source.subscription.subscriberProperties = {};
      _config.source.subscription.subscriberProperties[this.serviceProperty] = this.name;
   }
