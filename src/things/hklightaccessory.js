...
HomekitLightAccessory.prototype.setPower = function(_status) {
   this.setManualMode(this.powerProp);
   this.updateProperty(this.powerProp, _status ? true : false);
};
